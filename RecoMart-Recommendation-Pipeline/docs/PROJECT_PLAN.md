...
- Feature Engineering (Member 3): fully implemented at `src/features` — user/item/interaction feature tables, SQL schema, and a custom versioned feature store in `feature_store/`. See `docs/07_Feature_Engineering_Guide.md`.
